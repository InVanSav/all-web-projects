        ...
        <center>
            <div id="clock" class="progress-clock">
                ...
                <button class="progress-clock__time-date" data-group="d" type="button">
                    <small class="date" data-unit="w">Sunday</small>
                    <br>
                    <span class="date" data-unit="mo">January </span>
                    <span class="date" data-unit="d">1</span>
                </button>
                ...
                <svg class="progress-clock__rings" width="256" height="256" viewBox="0 0 256 256">
                    ...
                    <g data-units="s">
                        ...
                        <circle class="progress-clock__ring-fill" data-ring="m" cx="128" cy="128" r="122" fill="none"
                            stroke="url(#pc-purple)" stroke-width="12" stroke-dasharray="766.5 766.5"
                            stroke-dashoffset="766.5" stroke-linecap="round" transform="rotate(-90,128,128)" />
                    </g>
                </svg>
            </div>
            <div class="description__calendar">
                This clock will remind you 
                when to get dumplings.
            </div>
        </center>
    </div>
</template>
